...
//   RespCommandsTier2(RespClient client) : tier1 = RespCommandsTier1(client);
...
//   Future<RedisTransaction> multi() async {
//     (await tier1.multi()).toSimpleString().payload == 'OK';
